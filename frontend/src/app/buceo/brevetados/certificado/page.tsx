...
export default function BuceoCertificado() {
  const titleVariants = {
  ...
  const excursion = {
    ...
    description:
      ...
      details: [
        ...
        <>
          Ideal para Buzos Certificados: Contamos con diversos puntos de buceos para todos los niveles.{" "}
          <span className="text-[#e12222] underline font-semibold">Hacé click y conocelos</span>
        </>,
      ],
    ...
    callToAction:
      "¿Listo para descubrir el mundo submarino? ¡Reserva tu buceo ahora y comienza tu aventura subacuática con nosotros!",
  ...
  const content = (
    <div
      className="bg-[#1a1917] border-l-4 border-[#e12222] p-4 rounded-lg shadow-md hover:bg-[#252422] transition-colors duration-300 cursor-pointer"
    >
  ...
  return index === 3 ? (
    <Link key={index} href="/buceo/puntos-de-buceo">
      {content}
    </Link>
  ) : (
