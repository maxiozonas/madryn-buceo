            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div className="flex flex-col justify-center">
                    ...
                    <p className="text-white/80 mb-4 leading-relaxed"
                        dangerouslySetInnerHTML={{ __html: intl.formatMessage({ id: 'courses.padi.description.1' }) }}
                    />

                    <p className="text-white/80 mb-4 leading-relaxed"
                        dangerouslySetInnerHTML={{ __html: intl.formatMessage({ id: 'courses.padi.description.2' }) }}
                    />

                    <p className="text-white/80 mb-4 leading-relaxed"
                        dangerouslySetInnerHTML={{ __html: intl.formatMessage({ id: 'courses.padi.description.3' }) }}
                    />

                    <p className="text-white/80 mb-4 leading-relaxed"
                        dangerouslySetInnerHTML={{ __html: intl.formatMessage({ id: 'courses.padi.description.4' }) }}
                    />

                    <p className="text-white/80 mb-4 leading-relaxed"
                        dangerouslySetInnerHTML={{ __html: intl.formatMessage({ id: 'courses.padi.description.5' }) }}
                    />
                </div>
