...
export const diveSites: DiveSite[] = [
  {
    ...
    description:
      "diveSites.primavera.description",
  ...
  },
  {
    ...
    description:
      "diveSites.albatros.description",
  ...
  },
  {
    ...
    description:
      "diveSites.miralles.description",
    ...
    media: [
      ...
      { type: "video", url: "/videos/puntos/mirages/miralles.mp4" },
      { type: "image", url: "/images/puntos/mirages/mirages.webp" },
      { type: "video", url: "/videos/puntos/mirages/miralles2.mp4" },
  ...
  },
  {
    ...
    description:
      "diveSites.chinoHushung.description",
    ...
    media: [
      ...
      { type: "video", url: "/videos/puntos/chino/chino3.mp4" },
  ...
  },
  {
    ...
    description:
      "diveSites.parqueNuevo.description",
  ...
  },
  {
    ...
    description:
      "diveSites.puntaCuevas.description",
    difficulty: "diveSites.puntaCuevas.difficulty",
    depth: "diveSites.puntaCuevas.depth",
    certification: "Scuba Diver",
    time: "15 min",
    media: [{ type: "image", url: "/images/puntos/folias/folias.webp" },
      { type: "video", url: "/videos/puntos/puntaCuevas/puntacuevas.mp4" }
    ],
    coords: [-42.75, -64.95],
  },
  {
    ...
    description:
      "diveSites.caletaParana.description",
  ...
  },
  {
    ...
    description:
      "diveSites.puntaLoma.description",
  ...
  },
  {
    ...
    description:
      "diveSites.lasPiedras.description",
